 ...
 * Author: DerMing_You
 */
public class PictureWallAdapter extends BaseRecyclerViewAdapter<PictureWallAdapter.ViewHolder> {
    ...
    public PictureWallAdapter(Context mContext, String[] urls, Handler mHandler) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View rootView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_picture_wall, parent, false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.ivGridPhoto.setImageResource(R.drawable.shape_item_empty);
        loadBitmaps(holder.ivGridPhoto, url);
    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        @BindView(R.id.iv_grid_photo)
        ImageView ivGridPhoto;

        ViewHolder(View itemView, PictureWallAdapter adapter) {
            super(itemView);
