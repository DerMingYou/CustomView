 ...
 * Author: DerMing_You
 */
public class EditTextWithClear extends AppCompatEditText implements View.OnFocusChangeListener,
        TextWatcher {
    //EditText右侧的删除按钮
            ...
            setFilters(new InputFilter[]{new InputFilter() {
                ...
                public CharSequence filter(CharSequence source, int start, int end, Spanned dest, int dstart,
                    ...
                    if (emojiMatcher.find()) {
                        ToastUtils.showShortToast(getContext(), getContext().getString(R.string.no_support_emoji_character));
                        return "";
                    }
                    return null;
                }
